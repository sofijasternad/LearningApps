package ru.freeit.tapper.presentation.view.icon
...
import ru.freeit.awesomebuttons.icon.RippleAnimator
...
class IconButton @JvmOverloads constructor(
    ...
    private val listeners = mutableListOf<(v: View) -> Unit>()
    ...
    override fun onTouchEvent(event: MotionEvent): Boolean {
        ...
        when (event.action) {
            ...
            MotionEvent.ACTION_UP -> {
                ...
                listeners.firstOrNull()?.invoke(this)
            }
        }
        return true
    }
